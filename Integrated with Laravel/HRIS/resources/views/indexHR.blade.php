           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="{{ URL::asset('assets/img/find_user.png') }}" class="user-image img-responsive"/>
					</li>
				
					
                    <li>
                        <a class="active-menu" href="{{ URL::asset('indexHR') }}"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                      <li>
                    ...
                    <li>
                      ...
                      <li  >
                        <a  href="{{ URL::asset('plantilla') }}"><i class="fa fa-table fa-3x"></i> Plantilla </a>
                    </li>
                    <li  >
